...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] bool waterTester;
    ...
    void playerDead()
    {
        ...
        if (form != 1 && IsWater())
        {
            DetectCollision.isDead = true;
            transform.position = new Vector2(19f, -0.7f);
        }
    }
    // change gravity form
    void completeForm2(){
    ...
    {
        waterTester = Physics2D.BoxCast(coll.bounds.center, coll.bounds.size, 0f, Vector2.down, 1f, waterLayer);
        return waterTester;
    }
    void movement()
    {
