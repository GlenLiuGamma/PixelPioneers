...
public class SendToGoogle : MonoBehaviour
{
    ...
    private void Awake()
    {
     ...
     private IEnumerator Post(string sessionID, string DeathCnt, string time, string TimeLeft, string DeathReason, string DeathPosition, string CurrentCharacter )
    {
    ...
    */
    ...
    public void Send(string DeathPosition, string DeathReason, string CurrentCharacter)
    {
     ...
     StartCoroutine(Post(_sessionID.ToString(),  _eventCount.Deathcnt.ToString(), Time.time.ToString(), Timeleft, DeathReason, DeathPosition, CurrentCharacter ));
     /*
